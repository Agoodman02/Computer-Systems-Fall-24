...
// commands are pulled from a stream of Tokens. You do NOT
//   need to understand this to use the Command class. 
...
{
private:
  string _args[MAX_ARGS];    // array of arguments
  int _numArgs;              // actual number of arguments
  string _in;                // input redirect filename, if any
  string _out;               // output redirect filename, if any
