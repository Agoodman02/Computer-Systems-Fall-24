...
int main(int argc, char *argv[])
{
  ...
  int sem_id = semget(myKeyVal, NUM_SEMS,    // first try to get it
                      0);
 
  if (sem_id==-1)   
    {
      sem_id = semget(myKeyVal, NUM_SEMS,   // if it fails, create it
